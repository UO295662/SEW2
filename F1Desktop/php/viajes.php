...
<header>
    ...
    <main>
        ...
        <section class="ubicacion">
            ...
            <input type="button" value="Obtener mapa estático" onclick="viaje.getMapaEstaticoGoogle('ubicacion');">
            
            <h3>Mapa Dinámico</h3>
            <p>Haz clic en el botón para mostrar el mapa dinámico basado en tu ubicación.</p>
            <input type="button" value="Obtener mapa dinámico" onclick="viaje.getMapaDinamico('ubicacion');">
        </section>
        <section>
